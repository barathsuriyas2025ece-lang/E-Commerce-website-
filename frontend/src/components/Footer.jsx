...
const Footer = () => {
  return (
    <footer className="bg-slate-950 text-slate-400 border-t border-slate-800 pt-12 pb-8 mt-20">
        ...
        <div className="grid grid-cols-2 md:grid-cols-4 gap-6 pb-10 border-b border-slate-800 text-slate-300">
          ...
          <div className="flex items-center gap-3">
            ...
            <div>
              ...
              <p className="text-xs text-slate-400">Easy doorstep pickup</p>
            </div>
          </div>
          <div className="flex items-center gap-3">
            <Headset className="w-8 h-8 text-indigo-400" />
            <div>
              <h4 className="text-sm font-semibold text-white">24/7 AI Support</h4>
              <p className="text-xs text-slate-400">Instant answers anytime</p>
            </div>
          </div>
        </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8 py-10">
          ...
          <div>
            ...
            <ul className="space-y-2 text-sm">
              <li><Link to="/shop?category=electronics" className="hover:text-indigo-400 transition">Laptops & Electronics</Link></li>
              <li><Link to="/shop?category=audio" className="hover:text-indigo-400 transition">Audio & Wearables</Link></li>
              <li><Link to="/shop?category=apparel" className="hover:text-indigo-400 transition">Apparel & Footwear</Link></li>
              <li><Link to="/shop?category=home" className="hover:text-indigo-400 transition">Home & Living</Link></li>
            </ul>
          </div>

          <div>
            <h3 className="text-sm font-semibold text-white tracking-wider uppercase mb-4">Customer Portal</h3>
            <ul className="space-y-2 text-sm">
              ...
              <li><Link to="/cart" className="hover:text-indigo-400 transition">View Shopping Cart</Link></li>
              <li><Link to="/profile" className="hover:text-indigo-400 transition">User Account</Link></li>
            </ul>
          </div>

          <div>
            <h3 className="text-sm font-semibold text-white tracking-wider uppercase mb-4">Newsletter</h3>
            <p className="text-xs text-slate-400 mb-3">Get exclusive offers & AI deal recommendations delivered to your inbox.</p>
            <div className="flex gap-2">
              <input
                type="email"
                placeholder="Enter email..."
                className="bg-slate-900 border border-slate-800 rounded-lg px-3 py-1.5 text-xs text-slate-200 placeholder-slate-500 focus:outline-none focus:border-indigo-500 flex-1"
              />
